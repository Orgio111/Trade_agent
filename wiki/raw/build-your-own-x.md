...
A compilation of well-written, step-by-step guides for re-creating favorite technologies from scratch.
...
* [**Java**: _Building Your Own Kafka-like System From Scratch_](https://github.com/buildthingsuseful/build-your-own-kafka)

## 3D Renderer

* [**C++**: _Introduction to Ray Tracing_](https://www.scratchapixel.com/lessons/3d-basic-rendering/introduction-to-ray-tracing/how-does-it-work)
...
* [**Python**: _How to build a Slack Bot with Python using Slack Events API & Django under 20 minutes_](https://medium.com/freehunch/how-to-build-a-slack-bot-with-python-using-slack-events-api-django-under-20-minute-code-included-269c3a9bf64e)
...
* [**JavaScript**: _Building a frontend framework, from scratch, with components_](https://mfrachet.github.io/create-frontend-framework/)
...
* [**JavaScript**: _Neural networks from scratch for JavaScript linguists_](https://hackernoon.com/neural-networks-from-scratch-for-javascript-linguists-part1-the-perceptron-632a4d1fbad2)
...
* [**C**: _C interpreter that interprets itself_](https://github.com/lotabout/write-a-C-interpreter)
...
* [**Node.js**: _Building A Simple Single Sign On(SSO) Server And Solution From Scratch In Node.js_](https://codeburst.io/building-a-simple-single-sign-on-sso-server-and-solution-from-scratch-in-node-js-ea6ee5fdf340)
